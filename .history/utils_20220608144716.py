...
def make_discrete_env(env, touch_only, redundant_actions, grid_shape, zoom_factors, grayscale):
    print('-'*128)
    ...
    env = DiscreteActionWrapper(env, grid_shape, redundant_actions=False) # action touch grid: 25 blocks
