...
# Environment args.
# flags.DEFINE_string('task_path', '../tasks/dodge/dodge_default.textproto', 'Path to task textproto file.')
# flags.DEFINE_string('task_path', '../tasks/2048/classic_2048.textproto', 'Path to task textproto file.')
# flags.DEFINE_string('task_path', '../tasks/blockinger/blockinger.textproto', 'Path to task textproto file.')
flags.DEFINE_string('task_path', '/home/slowlab/Projects/AndroidEnv/android_env/tasks/catch/catch_the_ball_default.textproto', 'Path to task textproto file.')
