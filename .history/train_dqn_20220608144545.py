...
from utils import save_model, load_model, make_discrete_env
...
env = make_discrete_env(original_env, touch_only=True, redundant_actions=False, grid_shape=(8, 6), zoom_factors=(1/24, 1/18), grayscale=True)
...
# MODEL_NAME = 'DQN_MLP'
MODEL_NAME = 'DQN_CNN_GRAY8060_8X6_mdp'
ENV_NAME = 'mdp_0003'
SAVE_PERIOD = 2500
START_SIZE = 200
