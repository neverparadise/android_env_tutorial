...
env = make_discrete_env(original_env, touch_only=True, redundant_actions=False, grid_shape=(6, 4), zoom_factors=(1/48, 1/27), grayscale=True)
...
# MODEL_NAME = 'DQN_MLP'
MODEL_NAME = 'DQN_CNN_GRAY8060_6X9_mdp'
ENV_NAME = 'mdp_0003'
SAVE_PERIOD = 2500
START_SIZE = 200
